...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "about.timeline.1.d": "Building high-performance backend systems with focus on Redis caching and distributed services on Linux with Docker.",
    "about.timeline.2.t": "Software Engineer @ MathCode Solutions",
    "about.timeline.2.d": "Self-employed full-stack engineering, building scalable solutions and consulting on architecture.",
    "about.timeline.3.t": "Software Engineer @ GlobalLogic",
    "about.timeline.3.d": "Developing enterprise software with OPC/OPC UA integration, microservices using Ocelot, MongoDB, Redis, Elasticsearch with Azure cloud infrastructure.",
    "about.timeline.4.t": "Junior Full Stack Developer @ GlobalLogic",
    "about.timeline.4.d": "Building web applications and maintaining robust testing suites with Angular and .NET Core.",
    "about.timeline.5.t": "Software Developer @ Smart EPC",
    "about.timeline.5.d": "Development of IoT data aggregation and visualization platform for utility management using Angular, C# and Azure.",
    "about.timeline.6.t": "Junior Software Developer",
    "about.timeline.6.d": "Automation with Python, database management and data extraction tools using Django framework and SQL Server.",
    "about.education": "Education",
    "about.education.heading": "Education timeline",
    "about.edu.1.t": "B.Sc. Computer Science",
    "about.edu.1.d": "Politechnika Śląska — Algorithms, data structures, and software engineering fundamentals.",
    "about.edu.2.t": "M.Sc. Computer Science",
    "about.edu.2.d": "Uniwersytet WSB Merito Chorzów — Distributed systems and software architecture.",
    "about.edu.3.t": "B.Sc. Logistics",
    "about.edu.3.d": "Politechnika Śląska — Supply chain and systems management.",
    "about.edu.4.t": "Technical High School",
    "about.edu.4.d": "III Liceum Ogólnokształcące im. Stefana Batorego — IT specialisation and first programming experience.",
  ...
  pl: {
    ...
    "about.timeline.1.t": "C# Server Developer @ SuperPlay",
    "about.timeline.1.d": "Budowanie wysokowydajnych systemów backendowych z fokusem na cache'owanie Redis i usługi rozproszone na Linuksie z Dockerem.",
    "about.timeline.2.t": "Software Engineer @ MathCode Solutions",
    "about.timeline.2.d": "Samozatrudnienie — full-stack engineering, budowanie skalowalnych rozwiązań i konsulting architektoniczny.",
    "about.timeline.3.t": "Software Engineer @ GlobalLogic",
    "about.timeline.3.d": "Tworzenie oprogramowania klasy enterprise z integracją OPC/OPC UA, mikrousługami (Ocelot), MongoDB, Redis, Elasticsearch na infrastrukturze Azure.",
    "about.timeline.4.t": "Junior Full Stack Developer @ GlobalLogic",
    "about.timeline.4.d": "Budowanie aplikacji webowych i utrzymywanie solidnych testów z użyciem Angulara i .NET Core.",
    "about.timeline.5.t": "Software Developer @ Smart EPC",
    "about.timeline.5.d": "Tworzenie platformy IoT do agregacji i wizualizacji danych dla zarządzania utylitami, przy użyciu Angulara, C# i Azure.",
    "about.timeline.6.t": "Junior Software Developer",
    "about.timeline.6.d": "Automatyzacja za pomocą Pythona, zarządzanie bazami danych i narzędzia do ekstrakcji danych przy użyciu Django i SQL Server.",
    "about.education": "Edukacja",
    "about.education.heading": "Historia edukacji",
    "about.edu.1.t": "Inż. Informatyka",
    "about.edu.1.d": "Politechnika Śląska — Algorytmy, struktury danych i podstawy inżynierii oprogramowania.",
    "about.edu.2.t": "Mgr inż. Informatyka",
    "about.edu.2.d": "Uniwersytet WSB Merito Chorzów — Systemy rozproszone i architektura oprogramowania.",
    "about.edu.3.t": "Inż. Logistyka",
    "about.edu.3.d": "Politechnika Śląska — Zarządzanie łańcuchem dostaw i systemy logistyczne.",
    "about.edu.4.t": "Technikum",
    "about.edu.4.d": "III Liceum Ogólnokształcące im. Stefana Batorego w Chorzowie — Profil informatyczny i pierwsze doświadczenie programistyczne.",
